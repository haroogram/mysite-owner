...
variable "efs_id" {
  type = string
  default = "fs-0c95aa56260780b75.efs.ap-northeast-2.amazonaws.com"
}
...
source "amazon-ebs" "mysite_ami" {
  ...
  vpc_id                      = "vpc-04d043d238264aa62"
  subnet_id                   = "subnet-0981956cd1b2ae53b"
  iam_instance_profile        = "mysite-s3-role"
